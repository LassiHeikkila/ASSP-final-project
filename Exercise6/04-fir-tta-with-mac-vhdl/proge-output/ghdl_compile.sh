...
ghdl -i --workdir=work vhdl/fifo_stream_in_1.vhd
ghdl -i --workdir=work vhdl/fifo_stream_out_1.vhdl
ghdl -i --workdir=work vhdl/mac.vhdl
ghdl -i --workdir=work vhdl/rf_1wr_1rd_always_1_guarded_0.vhd
ghdl -i --workdir=work vhdl/toplevel_globals_pkg.vhdl
ghdl -i --workdir=work vhdl/toplevel_imem_mau_pkg.vhdl
